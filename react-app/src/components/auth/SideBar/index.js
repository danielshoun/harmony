  ...
  const [activeServer, setActiveServer] = useState(null);
    ...
    useEffect(() => {
        if(location.pathname.includes('create')) {
            ...
            const firstActive = servers.userServers.find(server => server.id === Number(serverId));
    ...
    return (
        <div className="side-bar">
            <div className="default-icons">
                ...
                <div
                    className={`side-bar-icon${activeServer === "discover" ? " active-server" : ""}`}
            ...
            <div
                className={`side-bar-icon${activeServer === "create" ? " active-server" : ""}`}
